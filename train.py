...
training_args = TrainingArguments(
    output_dir=os.path.join(MODEL_DIR, f"lora_out_adapter_{DATETIME}", "checkpoints"),
...
# -------------------------------
model.save_pretrained(os.path.join(MODEL_DIR, f"lora_out_adapter_{DATETIME}", "adapter"))
